...
- Accuracy on a hand-checked sample (19 apps × 5 fields): **75.8% after pass 1 → 81.1% after the verification loops**. Hits and misses, including where the loops made an answer worse, are on the live page.
